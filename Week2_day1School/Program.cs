...
namespace Week2_day1School
{
    class Program
    {
        static void Main(string[] args)
        {
            //arrays never change ever
            //int favoriteNumber;
            ...
            //Console.Write(userName[1]);
            //Console.Write(userName[2]);
            //Console.Write(userName[3]);
            //Console.Write(userName[0]);
            //Console.Write(userName[4]);
            //Console.Write(userName[5]);
            //Console.Write(userName[2]);
            //Console.Write(userName[6]);
            //Console.WriteLine("\n");
